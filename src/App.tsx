...
const PrivacyZenmerryView = () => {
  return (
    ...
    >
      ...
      <Box>
        <p>
          Hugo Carnicelli built the Zenmerry app as a Free app. This SERVICE is provided by Hugo Carnicelli at no cost
        ...
        <p>
          ...
          accessible at Zenmerry unless otherwise defined in this Privacy Policy.
        </p>
        <p>
        ...
        <p>
          ...
          identifiable information, including but not limited to None. The information that I request will be retained
